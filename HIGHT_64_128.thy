...
definition encrypt_64_128 :: "state_64_128 \<Rightarrow> key_schedule_64_128 \<Rightarrow> state_64_128" where
  "encrypt_64_128 plaintext initial_keys = 
     encrypt_block block_size_64_128 key_size_64_128 plaintext initial_keys"

definition decrypt_64_128 :: "state_64_128 \<Rightarrow> key_schedule_64_128 \<Rightarrow> state_64_128" where
  "decrypt_64_128 ciphertext initial_keys = 
...
lemma encrypt_decrypt_inverse_64_128:
  ...
  shows "decrypt_64_128 (encrypt_64_128 P MK) MK = P"
  using assms
  unfolding encrypt_64_128_def decrypt_64_128_def
...
lemma decrypt_encrypt_inverse_64_128:
  ...
  shows "encrypt_64_128 (decrypt_64_128 C MK) MK = C"
  using assms
  unfolding encrypt_64_128_def decrypt_64_128_def
            encrypt_block_def decrypt_block_def
            generate_key_schedule_enc_64_128_def generate_key_schedule_dec_64_128_def
...
lemma test_encryption_64_128:
  "encrypt_64_128 test_P_64_128 test_MK_64_128 = expected_C_64_128"
  sorry

(* Test that decryption recovers plaintext *)  
lemma test_decryption_64_128:
  "decrypt_64_128 expected_C_64_128 test_MK_64_128 = test_P_64_128"
  sorry
